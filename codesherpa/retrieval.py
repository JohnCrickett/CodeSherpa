...
def vector_search(
    ...
    with conn.cursor() as cursor:
        ...
        cursor.execute(sql, [query_embedding, query_embedding, threshold, top_k])
...
def hybrid_search(
    ...
    """
    vec_results = vector_search(conn, embedder, query, top_k=top_k, threshold=threshold)
    ft_results = fulltext_search(conn, query, top_k=top_k)

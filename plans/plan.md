...
| [x] 19 | Memory management page: MemoryPage.svelte with project selector, display, search, CRUD, bulk delete | [task-19-memory-page.md](../specs/task-19-memory-page.md) | REQ-MEM-01 to 26 |
